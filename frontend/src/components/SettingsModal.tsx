          ...
          <div className="p-4 bg-zinc-800/20 rounded-2xl overflow-hidden active:outline-none focus:outline-none focus:ring-0">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-semibold text-white">Connection Management</p>
              </div>
            ...
            {showProxyDeleteConfirm ? (
              <div className="flex items-center gap-3 p-2 bg-red-500/5 rounded-xl animate-in slide-in-from-right-4 duration-300">
                <p className="text-[11px] font-bold text-red-400 uppercase tracking-wider flex-1">Clear Connections?</p>
                <div className="flex gap-2">
                   <button 
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-3 bg-white/5 rounded-xl border border-white/5">
                    <p className="text-[10px] font-bold text-zinc-500 uppercase mb-1 tracking-wider">Identities</p>
                    <p className="text-lg font-bold text-white">{proxyStatus.total}</p>
                  </div>
                  <div className="p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                    <p className="text-[10px] font-bold text-emerald-500/60 uppercase mb-1 tracking-wider">Active</p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 p-3 bg-sky-500/10 rounded-xl text-sky-400">
                  <AlertCircle className="w-4 h-4 shrink-0" />
                  <span className="text-[11px] leading-tight font-medium">Add connection identities to ensure stable downloads in high-traffic regions.</span>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    {isScraping ? 'Auto-Finding...' : 'Auto-Find Free'}
                  </button>
                </div>
              </div>
            )}
